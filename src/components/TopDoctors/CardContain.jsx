...
export const CardContain = ({ name, specialist, rating, img, review }) => {
  return (
    <div className="card-container">
      <div className="info-img-avatar-card img-fit-cover">
      ...
      <div className="user-info">
        ...
        <svg
            ...
            viewBox="0 0 16 16"
          >
            <path d="M8 .222l1.351 4.143h4.396a.417.417 0 0 1 .258.747L11.308 8.91l1.256 4.095a.417.417 0 0 1-.64.494L8 11.744l-3.924 2.553a.417.417 0 0 1-.64-.494l1.256-4.095L.995 5.112a.417.417 0 0 1 .258-.747h4.396L8 .222z" />
            <path
              fill-rule="evenodd"
              d="M15.354 5.146a.5.5 0 0 1-.145.678l-4.5 3.5a.5.5 0 0 1-.678 0l-4.5-3.5a.5.5 0 1 1 .534-.808L8 7.14l3.465-2.802a.5.5 0 0 1 .678 0z"
            />
          </svg>
          <p className="rating-section">{rating}</p>
          <li>{review}</li>
          <svg
            width="16"
            height="16"
